...
class generate_db():
    def __init__(self, dbname):
        ...
        cursor.execute("""CREATE TABLE IF NOT EXISTS testeinstellungen (
                            ...
                            profile_name text,
                            check_online text,
                            check_time_limited text,
                            check_introduction text,
                            entry_introduction text,
                            check_test_properties text,
                            ...
                            check_processing_time text,
                            entry_processing_time_in_minutes text,
                            check_processing_time_reset text,
                            check_examview text,
                            check_examview_username text,
                            check_show_ilias_nr text,
                            ...
                            check_mandatory_questions text,
                            check_use_previous_solution text,
                            check_show_test_cancel text,
                            radio_select_not_answered_questions text,
                            check_show_question_list_process_status text,
                            check_question_mark text,
                            check_overview_answers text,
                            check_show_end_comment text,
